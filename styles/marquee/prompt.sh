...
_ts_B=$(ts_raw '64;144;240')       _ts_pB=$(ts_c '64;144;240')
_ts_D=$(ts_raw '90;40;72')
_ts_M=$(ts_raw '255;64;144')       _ts_pM=$(ts_c '255;64;144')
...
ts_prompt_apply "$(ts_prompt_expand "${_ts_pM}[MARQUEE${_ts_pY} // EXT3${_ts_pM}]${_ts_pX} ${_ts_pM}[${_ts_pB}{CWD}${_ts_pM}]${_ts_pX}{NL}${_ts_pM}>${_ts_pX} ")"
