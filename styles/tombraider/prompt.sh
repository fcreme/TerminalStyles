...
_ts_C=$(ts_raw '64;224;224')       _ts_pC=$(ts_c '64;224;224')
_ts_D=$(ts_raw '90;40;72')
_ts_M=$(ts_raw '255;48;136')       _ts_pM=$(ts_c '255;48;136')
...
ts_prompt_apply "$(ts_prompt_expand "${_ts_pM}[CROFT${_ts_pY} // EXT3${_ts_pM}]${_ts_pX} ${_ts_pM}[${_ts_pC}{CWD}${_ts_pM}]${_ts_pX}{NL}${_ts_pM}>${_ts_pX} ")"
